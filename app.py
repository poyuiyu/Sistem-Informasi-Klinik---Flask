...
from flask import Flask, render_template, redirect, url_for, session, request, flash, jsonify, current_app, make_response
...
app.config['SECRET_KEY'] = 'ayangbebku'
...
def dashboard():
    ...
    return render_template('includes/dashboard.html', data1=data1, data2=data2, data3=data3, data4=data4, data5=data5)
